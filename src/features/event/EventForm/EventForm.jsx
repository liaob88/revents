...
import TeaxtArea from '../../../app/common/form/TeaxtArea';
import TextInput from '../../../app/common/form/TextInput';
import SelecctInput from '../../../app/common/form/SelecctInput';
        ...
        <Grid.Column width={10}>
          <Segment>
            ...
            <Form onSubmit={this.props.handleSubmit(this.onFormSubmit)} autoComplete='off'>
              <Field name='title' component={TextInput} placeholder='Given your Event Title'/>
              <Field name='category' component={SelecctInput} options={category} placeholder='What is your event about?'/>
              <Field name='description' component={TeaxtArea} rows={3} placeholder='Tell us about your event'/>
